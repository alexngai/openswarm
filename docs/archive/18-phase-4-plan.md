...
- Update [docs/archive/16-parity-plan.md § Phase 4](16-parity-plan.md) with a "see Phase 4 plan" cross-reference (mirror what we did to the Phase 3 scope text).
- Update [docs/archive/15-parity-gaps.md](15-parity-gaps.md): mark T1, T6, T7 as ✅ shipped.
...
From [docs/archive/16-parity-plan.md:197-200](16-parity-plan.md), refined:
...
- [x] **Docs + cleanup (Stage D):** `docs/archive/15-parity-gaps.md` marks T1/T6/T7 ✅; `docs/archive/16-parity-plan.md` § Phase 4 gains implementation note cross-referencing this file; `docs/archive/18-phase-4-plan.md` status updated to shipped. Commit immediately follows 1df9547.
