...
and [docs/archive/34-acp-b1-meta-swarm-plan.md](34-acp-b1-meta-swarm-plan.md) (B1, shipped). B1 made the
...
- [docs/archive/34-acp-b1-meta-swarm-plan.md](34-acp-b1-meta-swarm-plan.md) — `_meta.swarm` schema the renderer reads.
