...
Companion to [docs/archive/20-v0.1-launch.md](20-v0.1-launch.md). After v0.1 ships, this is the planned order of releases. Three releases, sequenced for compounding value: v0.2 closes documented gaps, v0.3 unblocks the last roadmapped phase, v0.4 makes the vision tagline real.

**Authoring date:** 2026-04-30.
**Status:** v0.2 shipped 2026-04-30 (commits `deaf038..5ba50ff` + Stage 2G); v0.3 shipped 2026-05-01; v0.4 shipped 2026-05-02 (commits `0bd0f20..<close-out>`). See [docs/archive/27](27-v0.4-teams-implementation-plan.md) for the canonical v0.4 execution plan and stage-by-stage commit hashes.
...
- Write `docs/archive/22-a2-branch-lock-audit.md` with the function-by-function gap table.
...
| D2 smoke suite | Stage 2F: audited in `docs/archive/23-d2-smoke-audit.md`; 8 scripts / 35+ trajectories documented; gaps listed with effort estimates. |
...
> **REDESIGNED 2026-04-30:** the original plan targeted the HTTP SSE endpoint at `chatgpt.com/backend-api/codex/responses`. Web research surfaced that the **officially supported integration surface is the Codex App Server (JSON-RPC over stdio), not the private browser-to-backend SSE channel.** v0.3 now pivots to the App Server approach — same end-user feature, lower risk, no SSE spike. Full plan + design lock at [docs/archive/24-phase-6-codex-app-server-plan.md](24-phase-6-codex-app-server-plan.md).
>
> **Supersedes:** [docs/archive/14-m4b-plan.md § Phase 5](14-m4b-plan.md) and [docs/06-open-questions.md Q20](../06-open-questions.md).
...
- **v0.4 — released:** 2026-05-02 (commits `0bd0f20..<close-out>`) — Team orchestration. See [docs/archive/27](27-v0.4-teams-implementation-plan.md) for stage-by-stage commit hashes.
