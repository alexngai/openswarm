...
| Update `docs/archive/24-phase-6-codex-app-server-plan.md` with the Track B addition + lock the field-version compat story | 0.25 day | `docs/archive/24-phase-6-codex-app-server-plan.md` |
...
- `docs/archive/24-phase-6-codex-app-server-plan.md` — v0.3 design lock
