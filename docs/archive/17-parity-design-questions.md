...
Companion to [16-parity-plan.md](16-parity-plan.md). These are the decisions that will shape *how* phases get built, not *whether*. Each has a **Lean** — a provisional call so work isn't blocked, but nothing is locked until we discuss. Resolved items move to the decision log in [15-parity-gaps.md](15-parity-gaps.md).
...
**Why it matters.** Without a stopping criterion, this plan grows forever. Phase 1–5 close ~70% of the gaps in [15-parity-gaps.md](15-parity-gaps.md). Do we stop there, or push to 90%+?
