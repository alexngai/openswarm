...
- Mark TO1, A1, A5 as ✅ in [docs/archive/15-parity-gaps.md](15-parity-gaps.md) with stage citations.
- Add an "Implementation note" block in [docs/archive/16-parity-plan.md § Phase 5](16-parity-plan.md) pointing at this doc.
...
From [docs/archive/16-parity-plan.md:240-244](16-parity-plan.md):
...
- [x] **Docs + parity-gap updates (Stage D):** `docs/archive/15-parity-gaps.md` marks TO1/A1/A5 ✅; `docs/archive/16-parity-plan.md` § Phase 5 gains implementation note cross-referencing this file; `docs/archive/19-phase-5-plan.md` status updated to shipped. Stage D commit immediately follows 8f3ac44.
