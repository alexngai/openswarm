...
- Update `docs/archive/15-parity-gaps.md` row P4: ⚠️ → ✅ with a citation pointing at this doc.
- Update `README.md` "Models & aliases" section: document the `--framework codex-chatgpt` mode + the `codex login` prerequisite.
- Update `docs/archive/16-parity-plan.md` § Phase 6 with an "Implementation note" pointing at this doc (mirror the Phase 3/4/5 cross-reference style).
- Update `docs/06-open-questions.md` Q20: REVISITED — App Server pivot makes the SSE spike moot.
- Update `docs/archive/14-m4b-plan.md` § Phase 5: SUPERSEDED by this doc; preserve the historical record.
- Update `docs/archive/21-roadmap-v0.2-to-v0.4.md` v0.3 section: replace the current "wait for SSE spike" plan with the App Server flow.
...
| Doc | Section | Action |
|---|---|---|
| `docs/archive/14-m4b-plan.md` | § Phase 5 (Codex ChatGPT custom TransportProvider) | Marked SUPERSEDED 2026-04-30; points here |
| `docs/06-open-questions.md` | Q20 (Codex SSE spike) | Marked RESOLVED 2026-04-30 — pivot makes it moot |
| `docs/archive/16-parity-plan.md` | § Phase 6 — OpenAI OAuth | Implementation-note block points here |
| `docs/archive/21-roadmap-v0.2-to-v0.4.md` | § v0.3 Phase 6 stage breakdown | Rewritten to match Stages 3.0–3E |
