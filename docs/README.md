...
- [55-cross-harness-cache-efficiency.md](./55-cross-harness-cache-efficiency.md) — cache-efficiency lessons from DeepSeek-Reasonix: native-path prefix-stability guard, cache-miss attribution, self-calibrated token estimate, verbatim user-constraint pinning (TE-19…TE-24 plan; extends 48/53)
