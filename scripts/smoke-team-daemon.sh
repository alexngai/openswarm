...
SWARM_HARNESS_DAEMON_SPEC="$SPEC" \
SWARM_HARNESS_DAEMON_SOCK="$SOCK" \
SWARM_HARNESS_DAEMON_PID="$PID_FILE" \
SWARM_HARNESS_DAEMON_EVENTS="$EVENTS" \
SWARM_HARNESS_DAEMON_STATE="$STATE" \
